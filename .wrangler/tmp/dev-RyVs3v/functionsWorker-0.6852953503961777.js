...
// .wrangler/tmp/pages-gtTtHJ/functionsWorker-0.6852953503961777.mjs
...
var RECIPIENT_EMAIL = "hello@sagestoneinc.com";
...
__name(encodeUtf8Base64, "encodeUtf8Base64");
__name2(encodeUtf8Base64, "encodeUtf8Base64");
function toReadableStream(str) {
  const response = new Response(str);
  return response.body ?? new ReadableStream();
}
__name(toReadableStream, "toReadableStream");
__name2(toReadableStream, "toReadableStream");
function encodeHeaderValue(str) {
  const safe = str.replace(/[\r\n]/g, "");
  if (/^[\x20-\x7E]*$/.test(safe)) return safe;
  return `=?UTF-8?B?${encodeUtf8Base64(safe)}?=`;
}
__name(encodeHeaderValue, "encodeHeaderValue");
__name2(encodeHeaderValue, "encodeHeaderValue");
...
__name(sanitizeEmailForHeader, "sanitizeEmailForHeader");
__name2(sanitizeEmailForHeader, "sanitizeEmailForHeader");
...
__name(formatMailbox, "formatMailbox");
__name2(formatMailbox, "formatMailbox");
...
var onRequestPost = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    if (!message || message.length < 10 || message.length > 5e3) {
...
// .wrangler/tmp/bundle-t0et0L/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-t0et0L/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6852953503961777.js.map
