...
const routes = [
  ...
  ["/faqs", "Virtual Assistant Services FAQ | SageStone Inc", "Answers to common questions about SageStone Inc virtual assistant services, customer support outsourcing, ecommerce support, business operations support, and back-office workflows."],
  ...
  ["/customer-support", "Customer Support Services for Growing Teams | SageStone Inc", "Customer support services for growing teams that need organized inboxes, ticket triage, response templates, escalation rules, and customer follow-up."],
  ["/customer-support-virtual-assistant", "Customer Support Virtual Assistant Services | SageStone Inc", "Customer support virtual assistant services for inbox triage, customer replies, ticket organization, follow-up, reporting, and escalation workflows."],
  ...
  ["/ecommerce-operations-support", "Ecommerce Operations Support | SageStone Inc", "Ecommerce operations support for Shopify stores and online brands that need help with orders, returns, product updates, customer messages, and recurring workflows."],
  ...
  ["/real-estate-virtual-assistant-services", "Real Estate Virtual Assistant Services | SageStone Inc", "Real estate virtual assistant services for CRM updates, listings, scheduling, lead follow-up, transaction tasks, and admin support."],
  ...
  ["/social-media-management-services", "Social Media Management Support | SageStone Inc", "Social media management support for scheduling, content calendars, approved posts, engagement tracking, asset organization, and reporting."],
  ["/social-media-support", "Social Media Support Services | SageStone Inc", "Social media support services for content calendars, scheduling, engagement tracking, asset organization, campaign checklists, and reporting prep."],
  ...
  ["/crm-admin-support", "CRM & Admin Support | SageStone Inc", "CRM and admin support for data cleanup, follow-up, inbox management, calendar coordination, reporting prep, and recurring back-office workflows."],
  ["/gohighlevel-virtual-assistant", "GoHighLevel Virtual Assistant Support | SageStone Inc", "GoHighLevel virtual assistant support for CRM organization, workflow follow-up, pipeline updates, lead tracking, calendar support, and admin routines."],
  ["/web-design-maintenance-services", "Web Design and Maintenance Services | SageStone Inc", "Website maintenance support for content edits, page QA, links, forms, landing pages, image swaps, publishing coordination, and routine web updates."],
  ...
  ["/web-maintenance-services", "Web Maintenance Services | SageStone Inc", "Web maintenance services for small businesses and teams that need content updates, QA checks, link reviews, forms, landing pages, and publishing support."],
